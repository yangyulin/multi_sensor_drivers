...
void
bot_quat_rotate_to (const double rot[4], const double v[3], double r[3])
{
...
void
bot_quat_rotate (const double rot[4], double v[3])
{
    double ab  =  rot[0]*rot[1], ac  =  rot[0]*rot[2], ad  =  rot[0]*rot[3];
    double nbb = -rot[1]*rot[1], bc  =  rot[1]*rot[2], bd  =  rot[1]*rot[3];
    double ncc = -rot[2]*rot[2], cd  =  rot[2]*rot[3], ndd = -rot[3]*rot[3];
...
void
bot_angle_axis_to_quat (double theta, const double axis[3], double q[4])
{
